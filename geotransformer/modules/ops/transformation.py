...
def get_rotation_translation_from_transform_w_scale(transform):
    ...
    """
    scale = torch.matmul(transform[..., :3, :3], transform[..., :3, :3].transpose(-1,-2))[..., 0:1, 0:1] ** 0.5
...
def get_rotation_translation_from_transform(transform):
    ...
    Returns:
        ...
        translation (Tensor): (*, 3)
    """
    rotation = transform[..., :3, :3] / torch.matmul(transform[..., :3, :3], transform[..., :3, :3].transpose(0,1))[0, 0]
    translation = transform[..., :3, 3]
