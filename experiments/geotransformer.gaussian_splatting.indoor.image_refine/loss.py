...
class OverallLoss(nn.Module):
    ...
    def forward(self, output_dict, data_dict):
        ...
        loss = 10 * output_dict['masked_cross_entropy'] + self.weight_coarse_loss * coarse_loss + self.weight_fine_loss * fine_loss

        return {
            'loss': loss,
            'abs_error': output_dict['abs_error'],
            'masked_cross_entropy': output_dict['masked_cross_entropy'],
            'c_loss': coarse_loss,
            'f_loss': fine_loss,
        }
